...
contract Keanu is Context, IERC20, Ownable {
    ...
    address private _charity = owner();
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 70000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Keanu";
    string private _symbol = "REEVES";
    ...
    uint256 public _maxTxAmount = 70000 * 10**6 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 35000 * 10**6 * 10**9;
    ...
    function setCharityOwner(address newOwner) external onlyOwner() {
        _charity = newOwner;
    }
